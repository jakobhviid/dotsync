#!/bin/sh
# dotsync installer — no Homebrew, no compiler, no root. Downloads the prebuilt
...
#
# Override the install dir with DOTSYNC_BIN_DIR.
set -eu

REPO="jakobhviid/dotsync"
NAME="dotsync"
...
echo "Done. Run \`dotsync init\` to get started."
